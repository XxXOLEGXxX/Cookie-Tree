...
addLayer("c", {
	...
	upgrades: {
		...
		21: {
			...
			unlocked() {return player.c.buyables[31] >= 1},
		},
		22: {
			title: "Copy and Paste",
			description: "Modders gain +1% CpS per modder.<br/>[Multiplier Type]",
			cost: new Decimal(5000),
			unlocked() {return player.c.buyables[31] >= 10},
		},
		23: {
			title: "Cookie Dew",
			description: "Modders are twice as effecient.<br/>[Multiplier Type]",
			cost: new Decimal(50000),
			unlocked() {return player.c.buyables[31] >= 25},
		},
		24: {
